...
-   Upload a screenshot, showing that you completed the required levels, to any image hosting service (I personally use [imgur](https://alx-intranet.hbtn.io/rltoken/m_O2HLsKrO1zg31LMcLOGQ "imgur"), My profile link on `imgur.com` [imgur](https://kalwhyte.imgur.com/all) but feel free to use anything you want).
